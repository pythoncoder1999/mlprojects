#feature enginnering, data cleaning, etc.
import sys
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(str(train_df.columns))
            ...
            train_arr = np.c_[input_feature_train_arr, np.array(target_feature_train_df)] #concatonates along the second axis (column)
            test_arr = np.c_[input_feature_test_arr, np.array(target_feature_test_df)] #concatonates along the second axis (column)
